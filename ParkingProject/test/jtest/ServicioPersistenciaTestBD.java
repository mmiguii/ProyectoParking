...
import backend.clases.personas.personal.*;
...
public class ServicioPersistenciaTestBD {
	...
	public void testOrdinarioDeleteTrue() {
		ClienteOrdinario c = new ClienteOrdinario("1234ABC", "Normal", System.currentTimeMillis(), System.currentTimeMillis(), 1.0);
	...
	public void testSubscritoInsertFalse() {
		ClienteSubscrito c = new ClienteSubscrito("Mes", -100, new Plaza(400, true, "Normal"));
	...
	public void testSuscritoDeleteTrue() {
		ClienteSubscrito c = new ClienteSubscrito("1234AAA", "Normal", System.currentTimeMillis(), System.currentTimeMillis(), 100);
	...
	public void testGetPlazasDisponibles() {
		assertTrue(ServicioPersistenciaBD.getPlazasDisponibles() <= 300 && ServicioPersistenciaBD.getPlazasDisponibles() >= 0);
	}
	...
	public void testUsuario() {
		ServicioPersistenciaBD.ordinarioInsert(new ClienteOrdinario("1234AAA", "Normal", System.currentTimeMillis(), System.currentTimeMillis(), 2.0));
