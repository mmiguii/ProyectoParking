...
public class BajaSubscribersPanel extends JPanel{
	...
	public BajaSubscribersPanel(final JFrame frame) {
		...
		JList<SubscriberCustomer> miLista = new JList();
		DefaultListModel modeloLista = new DefaultListModel<>();
		SubscriberCustomer sc = new SubscriberCustomer(2000, 1);
		...
		btnVolver.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				WellComingWorkerPanel panel = new WellComingWorkerPanel(frame, null, null);
				frame.add(panel);
				setVisible(false);
